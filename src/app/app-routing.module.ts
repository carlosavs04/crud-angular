...
const routes: Routes = [
  ...
  { path: 'materias/create', component: MateriasCreateComponent, title: 'Añadir materia', canActivate: [AdminGuard] },
  { path: 'profesores/create', component: ProfesoresCreateComponent, title: 'Añadir profesor', canActivate: [AdminGuard] },
  { path: 'alumnos/update/:id', component: AlumnosUpdateComponent, title: 'Actualizar alumno', canActivate: [AdminGuard] },
  { path: 'carreras/update/:id', component: CarrerasUpdateComponent, title: 'Actualizar carrera', canActivate: [AdminGuard] },
  { path: 'materias/update/:id', component: MateriasUpdateComponent, title: 'Actualizar materia', canActivate: [AdminGuard] },
  { path: 'profesores/update/:id', component: ProfesoresUpdateComponent, title: 'Actualizar profesor', canActivate: [AdminGuard] },
