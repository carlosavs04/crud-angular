...
const routes: Routes = [
  ...
  { path: 'materias', component: MateriasTableComponent, title: 'Lista de materias',  canActivate: [AdminGuard], data: { roles: [1, 2, 3] }},
  { path: 'profesores', component: ProfesoresTableComponent, title: 'Lista de profesores', canActivate: [AdminGuard], data: { roles: [1, 2, 3] }},
  { path: 'users', component: UsersTableComponent, title: 'Lista de usuarios',  canActivate: [AdminGuard], data: { roles: [1, 2, 3] }},
  { path: 'alumnos/create', component: AlumnosCreateComponent, title: 'Añadir alumno', canActivate: [AdminGuard], data: { roles: [1, 3] }},
  { path: 'carreras/create', component: CarrerasCreateComponent, title: 'Añadir carrera',  canActivate: [AdminGuard], data: { roles: [1] } },
  { path: 'materias/create', component: MateriasCreateComponent, title: 'Añadir materia',  canActivate: [AdminGuard], data: { roles: [1] }},
  { path: 'profesores/create', component: ProfesoresCreateComponent, title: 'Añadir profesor',  canActivate: [AdminGuard], data: { roles: [1] }},
  { path: 'alumnos/update/:id', component: AlumnosUpdateComponent, title: 'Actualizar alumno', canActivate: [AdminGuard], data: { roles: [1] }  },
  { path: 'carreras/update/:id', component: CarrerasUpdateComponent, title: 'Actualizar carrera', canActivate: [AdminGuard], data: { roles: [1] } },
  { path: 'materias/update/:id', component: MateriasUpdateComponent, title: 'Actualizar materia', canActivate: [AdminGuard], data: { roles: [1] } },
  { path: 'profesores/update/:id', component: ProfesoresUpdateComponent, title: 'Actualizar profesor', canActivate: [AdminGuard], data: { roles: [1] } },
